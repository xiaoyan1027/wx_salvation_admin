 ...
 */
//rest api
require_once(FRAMEWORK_DIR . "/lib/file/resourceapi.php");

class lib_file_pic extends ResourceApiClient
{
     ...
     */
    public function upload_pic($dir_name = 'gallery', $field_name = '', $watermark = 0 , $max_size ='')
    {
     ...
     * @return multitype:string
     */
    public function upload_base64_pic($imgData, $dir_name = 'gallery', $watermark = 0)
    {
        if(empty($imgData))
        {
            return $this->result(false, '文件不存在');
